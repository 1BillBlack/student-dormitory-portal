        ...
        <CardContent>
          ...
          <Alert className="mt-4 border-primary/20 bg-primary/5">
            ...
            <AlertDescription className="text-xs ml-2">
              <strong className="block mb-1">Тестовые аккаунты (пароль: admin):</strong>
              <div className="space-y-0.5 font-mono text-[11px]">
                <div>manager@dorm.ru</div>
                <div>admin@dorm.ru</div>
                <div>moderator@dorm.ru</div>
                <div>vice@dorm.ru</div>
                <div>member@dorm.ru</div>
              </div>
            </AlertDescription>
          </Alert>
        </CardContent>
